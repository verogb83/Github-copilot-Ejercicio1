...
activities = {
    ...
    "Drama Society": {
        "description": "Rehearse and perform short plays and improv scenes",
    ...
    "Science Olympiad": {
        ...
        "max_participants": 18,
        "participants": ["emma@mergington.edu", "nathan@mergington.edu"]
    }
}
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # vlidate email is not already signed up
